...
./cashlens cash income -c "Salary" -a 5000 -d "20251212" -e "Salary"
./cashlens cash outcome -c "Food" -a 45.50 -d "20251212" -e "Lunch"
./cashlens cash query -d "20251212"
./cashlens cash range -f "20251201" -t "20251231"
./cashlens cash summary --type daily -d "20251212"

# Data management
./cashlens manage export -f "20251201" -t "20251231" -o "backup.xlsx"
./cashlens manage import -i "backup.xlsx"
```
...
| Problem | Solution |
|---------|----------|
| Port 8080 in use | `./cashlens server start -p 8081` |
...
| Permission denied | `chmod +x cashlens` |
...
- **API Test Guide**: `backend/docs/api_test_guide.md` (all 21 endpoints)
...
### Complete (30 min)
- [ ] All 21 endpoints (see `backend/docs/api_test_guide.md`)
- [ ] Error cases
- [ ] Pagination
- [ ] Filtering
