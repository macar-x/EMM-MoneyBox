// MongoDB initialization script for Cashlens - SCHEMA ONLY
// This script creates the database, collections, and inserts basic default categories
// Demo/test data is available in init-mongo-demo.js (import manually via CLI: cashlens manage import)
...
print('\n=== Cashlens MongoDB Initialized ===');
print(`Categories: ${db.categories.countDocuments()}`);
print(`Cash Flows: ${db.cash_flows.countDocuments()}`);
print('Schema only - no demo data loaded');
print('Load demo data via: cashlens manage import -i demo-data.xlsx');
print('=====================================\n');
